...
/**
 * TextField empleado por los formularios para los valores correspondientes a fechas.
 * 
...
public class Campo_Fecha extends CampoTexto {
	 ...
	 * 
	  * @return True si el texto corresponde al formato válido de las fechas. False si no.
	 */
	@Override
