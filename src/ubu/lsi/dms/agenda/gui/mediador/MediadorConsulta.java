...
public class MediadorConsulta extends Mediador {
	...
	/**
	 * Valor del contenido de la etiqueta correspondiente a la id del tipo de
	 * contacto
	 */
	 ...
	 * Muestra la tabla que contendrá los resultados de las consultas. Si todos
	 * los campos de texto activos están correctamente rellenados, habilita el
	 * botón Aceptar.
	 */
	@Override
