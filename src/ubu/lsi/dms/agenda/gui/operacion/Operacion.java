...
/**
 * Operación que debe ejecutar un panel de formulario en función de si le
 * corresponde Actualizar, Consultar o Insertar.
 * 
...
public interface Operacion {
	 ...
	 * Actualizar, Consultar o Insertar según corresponda.
	 * 
	 * @param panelDato
