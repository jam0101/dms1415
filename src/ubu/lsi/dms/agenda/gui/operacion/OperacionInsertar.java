...
/**
 * Operación que debe ejecutar un panel de formulario al que le corresponde Insertar.
 * 
...
public class OperacionInsertar implements Operacion {
	...
	/**
	 * Método que ordena la realización la operación correspondiente a Insertar al panel de formulario dado.
	 * 
